...
class Game:
    ...
    def __init__(self, screen, chessboard):
        ...
        self.player_tips_r_image = pygame.image.load("images/MyTurn.jpg")
        self.player_tips_r_image = pygame.transform.scale(self.player_tips_r_image, (200, 200))
        self.player_tips_r_image_topleft = (550, 500)
        self.player_tips_b_image = pygame.image.load("images/openai.jpg")
        self.player_tips_b_image = pygame.transform.scale(self.player_tips_b_image, (100, 100))
        self.player_tips_b_image_topleft = (600, 100)
